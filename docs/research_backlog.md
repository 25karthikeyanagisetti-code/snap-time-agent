...
- `memory_population_audit` — Instrumentation experiment: snapshot the M store at ep5 by cell, count loyalty-vs-guilt memories and their |emotion| magnitudes. Resolves whether the symmetric vs asymmetric divergence inversion is mediated by per-class memory weight as predicted. (Elevated 2026-05-06.)
...
- `memory_population_audit` — Instrumentation experiment: snapshot the M store at ep5 by cell, count loyalty-vs-guilt memories and their |emotion| magnitudes. Resolves whether the symmetric vs asymmetric divergence inversion is mediated by per-class memory weight as predicted.
